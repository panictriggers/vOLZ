...
vOLZ-Linux-Debug:
	 $(PROJECTBUILD) vOLZ Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZ-Linux-DebugGame:
	 $(PROJECTBUILD) vOLZ Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZ-Linux-Shipping:
	 $(PROJECTBUILD) vOLZ Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZ-Linux-Test:
	 $(PROJECTBUILD) vOLZ Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZ:
	 $(PROJECTBUILD) vOLZ Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZEditor-Linux-Debug:
	 $(PROJECTBUILD) vOLZEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZEditor-Linux-DebugGame:
	 $(PROJECTBUILD) vOLZEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZEditor-Linux-Shipping:
	 $(PROJECTBUILD) vOLZEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZEditor-Linux-Test:
	 $(PROJECTBUILD) vOLZEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

vOLZEditor:
	 $(PROJECTBUILD) vOLZEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
