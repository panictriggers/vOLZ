...
unrealRootPath=/home/hugo/UnrealEngine
vOLZRootPath=/home/hugo/Documenten/Unreal Projects/vOLZ

gameProjectFile=/home/hugo/Documenten/Unreal Projects/vOLZ/vOLZ.uproject
...
include(vOLZSource.pri)
include(vOLZHeader.pri)
include(vOLZConfig.pri)
include(vOLZIncludes.pri)
include(vOLZDefines.pri)

vOLZ-Linux-Debug.commands = $$build vOLZ Linux Debug  -project="\"$$gameProjectFile\"" $$args
vOLZ-Linux-DebugGame.commands = $$build vOLZ Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
vOLZ-Linux-Shipping.commands = $$build vOLZ Linux Shipping  -project="\"$$gameProjectFile\"" $$args
vOLZ-Linux-Test.commands = $$build vOLZ Linux Test  -project="\"$$gameProjectFile\"" $$args
vOLZ.commands = $$build vOLZ Linux Development  -project="\"$$gameProjectFile\"" $$args

vOLZEditor-Linux-Debug.commands = $$build vOLZEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
vOLZEditor-Linux-DebugGame.commands = $$build vOLZEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
vOLZEditor-Linux-Shipping.commands = $$build vOLZEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
vOLZEditor-Linux-Test.commands = $$build vOLZEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
vOLZEditor.commands = $$build vOLZEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	vOLZ-Linux-Debug \
	vOLZ-Linux-DebugGame \
	vOLZ-Linux-Shipping \
	vOLZ-Linux-Test \
	vOLZ \
	vOLZEditor-Linux-Debug \
	vOLZEditor-Linux-DebugGame \
	vOLZEditor-Linux-Shipping \
	vOLZEditor-Linux-Test \
	vOLZEditor \
